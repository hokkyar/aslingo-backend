      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 text-gray-900">
            ...
            <!-- KELAS 7 -->
            <div class="flex items-center justify-between my-5 py-3 shadow-lg text-center text-2xl font-bold">
              <h2 class="mx-3">KELAS 7</h2>
              <button onclick="orderClass7.showModal()" class="btn btn-primary mx-3">Edit Order</button>
            </div>
            ...
            <dialog id="orderClass7" class="modal modal-bottom sm:modal-middle">
              <div class="modal-box">
                <h3 class="font-bold text-lg">Class 7</h3>
                <ul class="cursor-grabbing" id="sortableList7" sortable>
                  <li class="p-3 border m-2" v-for="lesson in lessons.filter(item => item.class === '7')"
                    :key="lesson.id" :data-id="lesson.id">
                    {{ lesson.lesson_name }}
                  </li>
                </ul>
                <div class="modal-action">
                  <button v-if="isLoading" class="btn btn-primary" disabled>Loading...</button>
                  <button v-else class="btn btn-primary" @click="saveOrder('sortableList7')">Save</button>
                  <form method="dialog">
                    <button class="btn">Close</button>
                  </form>
                </div>
            ...
            <div class="flex items-center justify-between my-5 py-3 shadow-lg text-center text-2xl font-bold">
              ...
              <button onclick="orderClass8.showModal()" class="btn btn-primary mx-3">Edit Order</button>
            </div>
            <div class="flex justify-center mx-[3.3rem] lg:justify-start flex-wrap gap-3">
            ...
            <dialog id="orderClass8" class="modal modal-bottom sm:modal-middle">
              <div class="modal-box">
                <h3 class="font-bold text-lg">Class 8</h3>
                <ul class="cursor-grabbing" id="sortableList8" sortable>
                  <li class="p-3 border m-2" v-for="lesson in lessons.filter(item => item.class === '8')"
                    :key="lesson.id" :data-id="lesson.id">
                    {{ lesson.lesson_name }}
                  </li>
                </ul>
                <div class="modal-action">
                  <button v-if="isLoading" class="btn btn-primary" disabled>Loading...</button>
                  <button v-else class="btn btn-primary" @click="saveOrder('sortableList8')">Save</button>
                  <form method="dialog">
                    <button class="btn">Close</button>
                  </form>
                </div>
            ...
            <div class="flex items-center justify-between my-5 py-3 shadow-lg text-center text-2xl font-bold">
              ...
              <button onclick="orderClass9.showModal()" class="btn btn-primary mx-3">Edit Order</button>
            </div>
            <div class="flex justify-center mx-[3.3rem] lg:justify-start flex-wrap gap-3">
            ...
            <dialog id="orderClass9" class="modal modal-bottom sm:modal-middle">
              <div class="modal-box">
                <h3 class="font-bold text-lg">Class 9</h3>
                <ul class="cursor-grabbing" id="sortableList9" sortable>
                  <li class="p-3 border m-2" v-for="lesson in lessons.filter(item => item.class === '9')"
                    :key="lesson.id" :data-id="lesson.id">
                    {{ lesson.lesson_name }}
                  </li>
                </ul>
                <div class="modal-action">
                  <button v-if="isLoading" class="btn btn-primary" disabled>Loading...</button>
                  <button v-else class="btn btn-primary" @click="saveOrder('sortableList9')">Save</button>
                  <form method="dialog">
                    <button class="btn">Close</button>
                  </form>
                </div>
